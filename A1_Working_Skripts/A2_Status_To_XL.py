...
####################################################################Fill in all destinations that are currently offline
        ...
        for item in offlineCBX:
            ...
            i = i + 1
            XXprintProgressBar(i,offlineAnzahl, prefix="Offlinestandorte werden in Excel übertragen")
...
######################################################################## Fill in all destinations that currently have a failure
        ...
        for item in fehlerCBX:
            ...
            #wb.save(xlsxPfad)
            i = i + 1
            XXprintProgressBar(i, fehlerAnzahl, prefix="Fehlerstandorte werden in Excel übertragen")
        i = 1
        wb.save(xlsxPfad)
