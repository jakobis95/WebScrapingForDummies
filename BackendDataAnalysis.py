...
def Get_cpoIds():
    ...
    print(cpoIds)
    return cpoIds
def Update_CBXCP_list(atoken, s):
    ...
    with open('AllCPs.json', 'w') as f:
        f.write(AllCBXcp.text)

def Update_CBX_Transaction_DB(atoken):
    i=0
    with open('AllCPs.json', 'r') as f:
        obj = json.load(f)
...
if __name__ == '__main__':
    ...
    # Update_CBXCP_list(atoken, s)
    # chargePointsIds = []
    # payload = ""
    # cpoIds = Get_cpoIds()
    # loadalldata(atoken, payload, s, size=2000)
